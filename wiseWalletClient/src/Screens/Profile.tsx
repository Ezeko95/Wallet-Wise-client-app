...
import { View, Text, StyleSheet, Image, ImageBackground, Modal, TouchableOpacity, Alert } from 'react-native';
                ...
                <Modal visible={openModal} animationType='slide' transparent={true}>
                    <View style={styles.modal}>
                      ...
                      <View style={styles.modalBi}>
                        <TouchableOpacity style={{height:40, width:39}} onPress={()=>setOpenModal(false)}>
                          <Text style={{color:"white", right: 20,bottom: 40, fontSize: 30}}>X</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{height:40, width:200, backgroundColor: "#0e2235f6", top: 200, left: 50, borderRadius:10, justifyContent: "center"}} onPress={()=>{
                          onCheckout()
                        }}>
                          <Text style={{color:"white", fontSize: 20, textAlign:"center"}}>Go Premium</Text>
                        </TouchableOpacity>
                      </View>
                      </ImageBackground>
                    </View>
